        ...
        if (primary_aln.is_reverse and supplementary_aln.is_reverse) or (not primary_aln.is_reverse and not supplementary_aln.is_reverse):
            if supplementary_q_start >= primary_q_end:
                ...
                if reference_dist >= 0:                    
                    ...
                    return EvidenceDuplicationTandem(primary_ref_chr, supplementary_ref_start, primary_ref_end, 2, "suppl", read_name)    
                ...
                if reference_dist >= 0:
                    ...
                    return EvidenceDuplicationTandem(primary_ref_chr, primary_ref_start, supplementary_ref_end, 2, "suppl", read_name)    
            else:
